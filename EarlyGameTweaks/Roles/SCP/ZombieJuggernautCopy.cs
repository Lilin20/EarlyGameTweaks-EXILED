...
{
    public class ZombieJuggernautCopy : CustomRole, ICustomRole
    {
        public override uint Id { get; set; } = 99;
        public override int MaxHealth { get; set; } = 1000;
        public override string Name { get; set; } = "SCP-049-2 - Juggernaut2";
        public override string Description { get; set; } = "Eine etwas mehr gepanzerte Art eines Zombies.";
        public override string CustomInfo { get; set; } = "SCP-049-2 - Juggernaut2";
        ...
        public override List<CustomAbility> CustomAbilities { get; set; } = new List<CustomAbility>
        {
            new ScaleAbility()
            {
                ...
                ScaleForPlayers = new Vector3(0.4f, 0.4f, 0.4f),
            },
            new EffectEnabler()
            {
